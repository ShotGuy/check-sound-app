...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground bg-gray-100 w-full",
            className
        )}
        {...props}
    />
    ...
    return (
        <button
            ...
            className={cn(
                ...
                isActive && "bg-white text-foreground shadow-sm text-black shadow",
